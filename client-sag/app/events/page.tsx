          ...
          <div className="flex bg-gray-100 p-1.5 rounded-2xl w-full md:w-auto">
            {["Upcoming", "Past"].map((tab) => (
              <button
                ...
                className={`flex-1 md:flex-none px-10 py-3 rounded-xl text-[11px] font-black uppercase tracking-widest transition-all duration-300 ${activeTab === tab ? "bg-white text-sag-blue shadow-sm" : "text-gray-400 hover:text-gray-600"
                  }`}
              >
                {tab} Events
              </button>
